...
function quizInit() {
	...
	$('.nextQuizBtn').on('click', function () {
		...
		$('.o_btn').css('background', 'url(../quizData/images/o_non.png)')
		$('.x_btn').css('background', 'url(../quizData/images/x_non.png)')
	...
	$('.nextQuizBtn').mouseover(function() {
		$(this).css('background', 'url(./common/quizData/images/btn_next_over.png)');
	})
	.mouseout(function() {
		$(this).css('background', 'url(./common/quizData/images/btn_next.png)');
	});
