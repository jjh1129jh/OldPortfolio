...
$("#fs-footer .next").on("click", function(){
	...
	/*6모듈 1페이지 클릭시 텍스트 이미지 변경*/
	$("#contents_box .img01_02").on("click", function(){
		$('.img01_02').attr("src", "./common/css/img/contents/img01_02_over.png")
	})
	/*6모듈 2페이지 클릭시 텍스트 이미지 변경*/
	$("#contents_box .img02_02").on("click", function(){
		$('.img02_02').attr("src", "./common/css/img/contents/img02_02_over.png")
	})
	/*6모듈 3페이지 클릭시 텍스트 이미지 변경*/
	$("#contents_box .img03_02").on("click", function(){
		$('.img03_02').attr("src", "./common/css/img/contents/img03_02_over.png")
	})
