...
document.write('<script language="javascript" src="./common/js/jquery-1.10.2.js"></script>');
...
document.write('<script language="javascript" src="./common/js/jquery.ui.touch-punch.js"></script>');
...
document.write("<script src='./common/quizData/quizElem.js'></script>")

document.write('<script language="javascript" src="./js/languageKor.js"></script>')
document.write('<script language="javascript" src="./js/languageEng.js"></script>')
document.write('<script language="javascript" src="./js/languageChi.js"></script>')
document.write('<script language="javascript" src="./js/languageVet.js"></script>')
document.write('<script language="javascript" src="./js/languageRus.js"></script>')
document.write('<script language="javascript" src="./js/languageCam.js"></script>')
...
if(top.bolPorted){
	...
	document.write('<script language="javascript" src="./common/js/coin.js"></script>')
	document.write('<link href="./common/css/coin.css"  rel="stylesheet" />');
}
